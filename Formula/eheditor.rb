...
class Eheditor < Formula
  ...
  homepage "https://github.com/go-coreutils/etc-hosts-editor"
  license "Apache-2.0"
  head "https://github.com/go-coreutils/etc-hosts-editor.git", branch: "release-v0.8.0"
